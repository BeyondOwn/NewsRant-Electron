  ...
  return (
    <div className="flex justify-center">
      ...
      <SearchForm
            ...
            <div className="flex flex-col md:flex-row bg-card p-4 gap-4">
              ...
              <div className='flex flex-col flex-grow min-w-0'>
                <Link className="hover:underline" href={article.link}>
                  <h3 className="font-khand font-bold text-secondary-foreground text-lg md:text-xl lg:text-2xl leading-tight line-clamp-2 mb-2">
                    {article.title}
                  </h3>
                </Link>
        ...
        }} className='text-secondary-foreground text-3xl font-khand font-bold place-self-center w-full h-10'>SHOW MORE</Button>
        <div
